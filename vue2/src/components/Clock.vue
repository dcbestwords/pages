...
export default {
    ...
    methods: {
        toggle() {
            this.btnText = this.isDark ? 'Dark mode' : 'Light mode';
        ...
        setDate() {
            ...
            const hourDeg = this.scale(hourFormat, 0, 12, 0, 360);
            const minuteDeg = this.scale(minute, 0, 60, 0, 360);
            const secondDeg = this.scale(second, 0, 60, 0, 360);

            this.day = day;
            this.date = date;
            this.month = month;
            this.hour = hourFormat;
            this.minute = minuteFormat;
            this.second = second;
            this.ampm = ampm;
